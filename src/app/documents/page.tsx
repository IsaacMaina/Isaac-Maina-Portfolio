  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimatedElement variant="zoomIn" className="mb-4">
          <h1 className="text-4xl font-bold text-center">
            <span className="text-accent-cyan">Document Explorer</span>
          </h1>
        </ScrollAnimatedElement>

        <ScrollAnimatedElement variant="slideUp" delay={0.1} className="mb-12">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      {items.filter(item => item.id === null).map((folder, index) => {
                        const isPrivate = folder.name.toLowerCase().includes('private');
                        ...
                        return (
                          <div
                            ...
                            onClick={() => canAccess ? navigateToFolder(folder.name) : null}
                          >
